...
class JarHcTest extends ReleaseTest {
	...
	private static final JavaImage[] JAVA_IMAGES = {
			...
			new JavaImage("ibm", "semeru", "11", "ibm-semeru-runtimes:open-11.0.26_4-jre"),
			new JavaImage("ibm", "semeru", "17", "ibm-semeru-runtimes:open-17.0.14_7-jre"),
			new JavaImage("ibm", "semeru", "21", "ibm-semeru-runtimes:open-21.0.6_7-jre"),
