---
description: Release notes for JarHC 3.0.0, new features, improvements, and changes.
---
...
* JarHC can load properties from `~/.jarhc/jarhc.properties` and `./jarhc.properties`.
