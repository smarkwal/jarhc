---
description: The JarHC Vulnerabilities report, known security vulnerabilities (CVEs) in the JAR files on your classpath, with severity and affected artifacts.
sources:
